...
import banner from '../Media/online-exclusive-deals.jpeg'
function onlineexclusivedeals() {
    const onlineecat= products.filter(product=>product.category==='online exclusive deals')
  return (
    <div className='container' id='exclusivedeals'>
...
export default onlineexclusivedeals
